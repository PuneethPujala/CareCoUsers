        ...
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            try {
                ...
                if (size == WidgetSizeHelper.SizeCategory.LARGE) {
                    ...
                    if (total == 0) {
                        views.setViewVisibility(R.id.widget_slots_grid, View.GONE)
                        ...
                        views.setTextViewText(R.id.widget_empty_subtitle, "No medications scheduled for today. Stay healthy!")
                        ...
                        views.setTextViewText(R.id.widget_empty_subtitle, "You've taken all of your medications today. Excellent job!")
                        views.setImageViewResource(R.id.widget_empty_mascot, R.drawable.doctor_mascot_celebration)
                    } else {
                        views.setViewVisibility(R.id.widget_slots_grid, View.VISIBLE)
