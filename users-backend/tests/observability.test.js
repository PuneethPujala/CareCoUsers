...
const mockAuthState = {
    user: { id: 'test-user', supabaseUid: 'test-user', email_confirmed_at: new Date().toISOString() },
...
describe('Observability Routes - System Health', () => {
    beforeEach(() => {
        ...
        mockAuthState.profile = { _id: 'patient-123', supabaseUid: 'test-user', role: 'patient' };
    });
    ...
    it('returns global metrics when authenticated as a non-Patient (e.g., care_manager)', async () => {
        ...
        mockAuthState.profile = { _id: 'staff-456', supabaseUid: 'staff-user', role: 'care_manager' };
