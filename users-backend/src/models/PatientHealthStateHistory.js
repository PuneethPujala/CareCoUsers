...
patientHealthStateHistorySchema.index({ patient_id: 1, date: 1 }, { unique: true });

// TTL index to automatically purge entries after 60 days
patientHealthStateHistorySchema.index({ expires_at: 1 }, { expireAfterSeconds: 0 });

module.exports = mongoose.model('PatientHealthStateHistory', patientHealthStateHistorySchema);
