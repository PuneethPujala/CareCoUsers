...
companionAiInsightHistorySchema.index({ expires_at: 1 }, { expireAfterSeconds: 0 });

module.exports = mongoose.model('CompanionAiInsightHistory', companionAiInsightHistorySchema);
