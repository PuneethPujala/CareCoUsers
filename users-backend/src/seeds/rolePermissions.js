...
const permissions = [
  ...
  {
    role: "org_admin",
    resource: "care_managers",
    action: "create",
    description: "Create care managers",
  },
  {
    role: "org_admin",
    resource: "care_managers",
    action: "read",
    description: "View care managers",
  },
  {
    role: "org_admin",
    resource: "care_managers",
    action: "update",
    description: "Update care managers",
  },
  {
    role: "org_admin",
    resource: "care_managers",
    action: "delete",
    description: "Delete care managers",
  },
  {
    role: "org_admin",
    resource: "caretakers",
    action: "create",
    description: "Create caretakers",
  },
  {
    role: "org_admin",
    resource: "caretakers",
    action: "read",
    description: "View caretakers",
  },
  {
    role: "org_admin",
    resource: "caretakers",
    action: "update",
    description: "Update caretakers",
  },
  {
    role: "org_admin",
    resource: "caretakers",
    action: "delete",
    description: "Delete caretakers",
  },
  {
    role: "org_admin",
    resource: "patients",
  ...
  {
    role: "org_admin",
    resource: "patient_mentors",
    action: "create",
    description: "Create patient mentors",
  },
  {
    role: "org_admin",
    resource: "patient_mentors",
    action: "read",
    description: "View patient mentors",
  },
  {
    role: "org_admin",
    resource: "patient_mentors",
    action: "update",
    description: "Update patient mentors",
  },
  {
    role: "org_admin",
    resource: "patient_mentors",
    action: "delete",
    description: "Delete patient mentors",
  },
  {
    role: "org_admin",
    resource: "profile",
  ...
  },
  {
    ...
    resource: "patients",
    action: "assign",
    description: "Assign patients to caretakers",
  },
  {
    role: "care_manager",
    resource: "patients",
    action: "authorize",
    description: "Authorize mentors for patients",
  },
  {
    role: "care_manager",
    resource: "patients",
    action: "revoke",
    description: "Revoke mentor authorizations",
  },
  {
    role: "care_manager",
    resource: "patient_mentors",
  ...
  },
  {
    ...
    resource: "mentors",
    action: "update",
    description: "Update mentor permissions",
  },
  {
    role: "care_manager",
    resource: "medications",
  ...
  },
  {
    ...
    action: "create",
    description: "Create escalations",
  },
  {
    role: "caretaker",
    resource: "profile",
  ...
  },
  {
    ...
    resource: "caretakers",
    action: "read",
    description: "View own caretaker info",
  },
  {
    role: "caretaker",
    resource: "caretakers",
    action: "update",
    description: "Update own caretaker info",
  },
  ...
  // Patient Mentor permissions
  {
    ...
    resource: "patients",
    action: "read",
    description: "View authorized patients",
  },
  {
    role: "patient_mentor",
    resource: "medications",
  ...
  },
  {
    ...
    resource: "call_logs",
    action: "read",
    description: "View patient call logs",
  },
  {
    role: "patient_mentor",
    resource: "health_journal",
    action: "create",
    description: "Create health journal entries",
  },
  {
    role: "patient_mentor",
    resource: "health_journal",
    action: "read",
    description: "View health journal entries",
  },
  {
    role: "patient_mentor",
    resource: "profile",
  ...
  },
  {
    ...
    resource: "mentors",
    action: "read",
    description: "View own mentor info",
  },
  {
    role: "patient_mentor",
    resource: "mentors",
    action: "update",
    description: "Update own mentor info",
  },
  ...
  },
  {
    ...
    resource: "medications",
    action: "read",
    description: "View own medications",
  },
  {
    role: "patient",
    resource: "call_logs",
    action: "read",
    description: "View own call logs",
  },
  {
    role: "patient",
    resource: "mentors",
    action: "authorize",
    description: "Authorize mentors",
  },
  {
    role: "patient",
    resource: "mentors",
...
const seedPermissions = async () => {
  try {
    ...
    console.log(
      `✅ Successfully seeded ${permissions.length} role permissions`,
    );
    ...
    if (error.code === 11000) {
      ...
      console.log(
        "💡 Consider clearing existing permissions first or updating individually",
      );
    }
