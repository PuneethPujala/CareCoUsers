...
const styles = StyleSheet.create({
    ...
    formCard: { marginTop: -24, marginHorizontal: 16, backgroundColor: '#FFFFFF', borderRadius: 28, paddingHorizontal: 24, paddingTop: 28, paddingBottom: 24, marginBottom: 16, shadowColor: '#0F172A', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.05, shadowRadius: 20, elevation: 4 },
    googleBtnEnhanced: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 16, height: 50, marginBottom: 12, shadowColor: 'rgba(0,0,0,0.02)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 1, shadowRadius: 4, elevation: 1 },
    googleG: { fontSize: 18, fontWeight: '700', color: '#4285F4', marginRight: 12 },
    googleBtnText: { fontSize: 15, fontWeight: '700', color: '#1E293B' },
    dividerRowPremium: { flexDirection: 'row', alignItems: 'center', marginVertical: 16, paddingHorizontal: 10 },
    ...
    inputWrapEnhanced: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#F1F5F9', borderRadius: 16, height: 52, paddingHorizontal: 16 },
    ...
    textInputEnhanced: { flex: 1, fontSize: 15, color: '#0F172A', fontWeight: '600' },
    fieldErrorEnhanced: { fontSize: 12, color: '#EF4444', fontWeight: '500', marginTop: 4, marginLeft: 2 },
    rightIconWrap: { marginLeft: 10 },
    strengthWrap: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4, marginBottom: 8 },
    strengthBarRow: { flexDirection: 'row', gap: 6, flex: 1 },
    strengthSeg: { flex: 1, height: 4, borderRadius: 2 },
    strengthLabel: { fontSize: 12, fontWeight: '700', width: 45, textAlign: 'right' },
    reqWrap: { marginTop: 4, marginBottom: 12, marginLeft: 2 },
    reqItem: { fontSize: 12, marginBottom: 4 },
    primaryBtnEnhanced: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#3B5BDB', borderRadius: 16, height: 52, width: '100%', gap: 8, shadowColor: '#3B5BDB', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
