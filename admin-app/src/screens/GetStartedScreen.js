                ...
                <View style={s.content}>
                    ...
                    <View style={s.btnGroup}>
                        <TouchableOpacity onPress={() => navigation.navigate('Login')} activeOpacity={0.9} style={s.loginWrap}>
                            <LinearGradient colors={['#6366F1', '#8B5CF6']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={s.loginBtn}>
...
const s = StyleSheet.create({
    ...
    title: { ...Typography.h1, color: '#0F172A', fontSize: 26, fontWeight: '800' },
    ...
    signupBtn: { paddingVertical: 16, alignItems: 'center', borderRadius: Radius.lg, borderWidth: 1.5, borderColor: '#6366F130', backgroundColor: '#F8FAFC' },
    signupText: { ...Typography.button, color: '#6366F1', fontSize: 16, fontWeight: '700' },
});
